...
import ex.LO_Sample.Log4j.FunnyToString;
...
public class LO_Sample {
	...
	public static class Log4j {
		...
		public static class Log4j2 {
			// tag LO_SUSPECT_LOG_CLASS
			private static org.apache.logging.log4j.Logger l1 = org.apache.logging.log4j.LogManager
			...
			public static org.apache.logging.log4j.Logger l7 = org.apache.logging.log4j.LogManager
					.getLogger(Log4j2.class);
			...
			// no tag
			public Log4j2() {
				this(org.apache.logging.log4j.LogManager.getRootLogger());

				someLocalLogger.info("Why am I using a local logger?");
			}

			// tag LO_SUSPECT_LOG_PARAMETER
			public Log4j2(org.apache.logging.log4j.Logger someLogger) {
				this.someLocalLogger = someLogger;
			}
			...
			public void testInvalidLog4j2Parm() {
				// tag LO_INVALID_FORMATTING_ANCHOR
				l3.error("This is a problem {0}", "hello");
			}

			public void testInvalidLog4j2Parm2() {
				// tag LO_INVALID_FORMATTING_ANCHOR
				l3.error("This is a problem %s", "hello");
				l3.error("This is a problem %3$-2.3e", 1);
				l3.error("This is a problem %5d", 3.1);
			...
			public void test465(String... args) {
				l1.error("main args " + args.length); // should raise LO_APPENDED_STRING_IN_FORMAT_STRING bug warning
				l1.error("main args {}" + args.length, args); // should raise LO_APPENDED_STRING_IN_FORMAT_STRING bug
																// warning
			}
			...
			public class Inner {
				public void fpUseAnon() {
					ActionListener l = new ActionListener() {
						...
						public void actionPerformed(ActionEvent ae) {
							// no tag
							org.apache.logging.log4j.LogManager.getLogger(Inner.class).error("fp");
							// tag LO_SUSPECT_LOG_CLASS
							org.apache.logging.log4j.LogManager.getLogger(LO_Sample.class).error("not fp");
						}
					};
				}
			}
